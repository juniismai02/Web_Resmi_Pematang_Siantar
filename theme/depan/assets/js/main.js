...
$(document).ready(function () {
  ...
  $(".slick-vertical-nav").slick({
    ...
    // centerMode: true,
    prevArrow:
      '<div class="arrow-vup arrow-v"><span class="arrowup"></span></div>',
    nextArrow:
      '<div class="arrow-vdown arrow-v"><span class="arrowdown"></span></div>',
    // arrows: false,
  ...
  $(".slick-three-slider").slick({
    ...
    slidesToScroll: 1,
    prevArrow:
      '<div class="arrow-hleft arrow-h"><span class="arrowleft"></span></div>',
    nextArrow:
      '<div class="arrow-hright arrow-h"><span class="arrowright"></span></div>',
    responsive: [
      {
        breakpoint: 992,
        settings: {
