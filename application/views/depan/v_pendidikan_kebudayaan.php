      ...
      <div class="sectionrow">
        <div class="featsection artikelwrap">
          <div class="xsection__header">
            <h1 class="xsection__title">Pendidikan Dan Kebudayaan</h1>
          </div>
          <div class="featsection__summary">
                <p>Pendidikan dan kebudayaan merupakan proses kreatif yang tak dapat dipisahkan, ibarat dua sisi dari keping uang yang sama. Bung Hatta secara tepat menyatakan bahwa apa yang diajarkan dalam proses pendidikan adalah kebudayaan, sedangkan pendidikan itu sendiri adalah proses pembudayaan.</p>
                <p>Dalam proses belajar menjadi manusia sebagai makhluk berkebudayaan, setiap individu memiliki tiga potensi besar sebagai kreator kebudayaan, yang disebutnya sebagai “trisaksi” insani: cipta (pikiran), yang membuahkan pengetahuan, pendidikan, filsafat; rasa yang membuahkan keindahan, keluhuran batin, seni, adat istiadat, penyesuaian sosial, nasionalisme, keadilan dan keagamaan; dan karsa (kemauan) yang menimbulkan perbuatan dan buatan manusia seperti industri, pertanian, bangunan-bangunan (arsitektur) dan lain-lain.</p>
          </div>
          ...
          <!-- <div class="buttonlist">
            <ul>
									...
									<li><a href="#">Featured Programs and Activities</a></li>
																
																							
									<li><a href="#">Planning Document</a></li>
									...
									<li><a href="#">Employee Data</a></li>
																								...
																								<li><a target="_blank" href="#">Work Program: Elective Affairs</a></li>
																
																								<li><a target="_blank" href="#">Work Program: Mandatory Affairs</a></li>
