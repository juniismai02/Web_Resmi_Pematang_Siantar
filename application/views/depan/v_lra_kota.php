...
<html lang="id">
  ...
  <head>
    ...
    <title>
      Website Resmi Kota Pematangsiantar - LRA Kota Pematangsiantar 2023 per SKPD

    </title>
    <meta
      name="title"
      content="Website Resmi Kota Pematangsiantar - LRA Kota Pematangsiantar 2023 per SKPD
"
    />
    <meta
      name="description"
      itemprop="description"
      content="Website Resmi Kota Pematangsiantar - Menyajikan Seputar LRA Kota Pematangsiantar 2023 per SKPD
"
    />
    <meta
      name="keywords"
          ...
          <div class="sectionrow">
            <div class="dinasterkait">
              <div class="xsection__header">
                <h1 class="xsection__title">LRA Kota Pematangsiantar 2023 per SKPD</h1>
              </div>
                  ...
                  <table class="zentable cityd-table" id="myTable">
                    ...
                    <?php 
                      ...
                      foreach ($data->result() as $row):
                          // Hanya menampilkan data yang memiliki nilai file_oleh sama dengan "Surat Edaran"
                          if ($row->file_oleh == "LRA Kota Pematangsiantar 2023 per SKPD"):
                      ?>
                          <tr>
                              <td><?php echo $no++;?></td>
