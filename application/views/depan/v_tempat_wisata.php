    ...
    <div class="mainwrap">
      <div class="sectionrow">
        <div class="featsection artikelwrap">
          ...
          <h1 class="xsection__title" >Jelajah Alam yang Indah</h1>
          </div>
          <br>
          <div class="xsection__header">
            <h1 class="xsection__title">Pulau Batu</h1>
            <br><br>
          </div>
          <div class="eta-wrap">
            <div class="eta-img"><img src="<?php echo base_url().'theme/depan/assets/img/pulau_batu.jpg'?>" alt="img"></div>
            <p>Wisata Pemandian taman air alami yang berlokasi di Jl. Sibatu-batu Kelurahan Bah Sorma.</p>
          </div>
          <br>
          <div class="xsection__header">
            <h1 class="xsection__title">Arung Jeram Bah Bolon</h1>
            <br><br>
          </div>
          <div class="eta-wrap">
            <div class="eta-img"><img src="<?php echo base_url().'theme/depan/assets/img/arum_jeram.jpg'?>" alt="img"></div>
            <p>Sungai Bah Bolon menjadi tempat menikmati alam dan bermain air yang sangat seru, disini menyediakan beberapa paket rafting yang pastinya aman dan terjangkau. Lokasi di kawasan aliran sungai Bah Bolon yang berdekatan dengan Rumah Dinas Wali Kota Siantar, Jalan Kapten M.H. Sitorus, Kelurahan Teladan, Kecamatan Siantar Barat.</p>
          </div>
          <br>
          <div class="featsection__summary">
          <h1 class="xsection__title" >Wisata Sejarah Dan Budaya</h1>
          </div>
          <br>
          <div class="xsection__header">
            <h1 class="xsection__title">Museum Simalungun</h1>
            <br><br>
          </div>
          <div class="eta-wrap">
          ...
          <br>
          <div class="xsection__header">
            <h1 class="xsection__title">Tugu Becak</h1>
            <br><br>
          </div>
          <div class="eta-wrap">
          ...
          <br>
          <div class="xsection__header">
            <h1 class="xsection__title">Pohon Natal</h1>
            <br><br>
          </div>
          <div class="eta-wrap">
          ...
          <br>
          <div class="xsection__header">
            <h1 class="xsection__title">Patung Dewi Kwan Im</h1>
            <br><br>
          </div>
          <div class="eta-wrap">
