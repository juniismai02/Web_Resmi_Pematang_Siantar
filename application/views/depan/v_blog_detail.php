 ...
 <div class="bdgcontent">
        ...
        <li><a href="https://kejari-pematangsiantar.kejaksaan.go.id/" target="_blank">Kejaksaan Negeri Pematangsiantar</a></li>
         ...
         <div class="menu__right">
              ...
              <div class="hujanbahasa">
                ...
                <div class="bahasa"><a href="#">ID</a> | <a href="#">EN</a></div>
              </div>
              <div class="search">
      ...
      <article class="artikelwrap">
        ...
        <div class="detailpage">
          <div class="detailhead">  
            <a href="../../berita.html" class="detail-cate">Berita</a>
            <h1 class="detail-judul"><?php echo $title;?></h1>
            <br>
           </div>
          ...
          <div class="detailbody">
            <div class="repshare">
              <div class="repshare__col">
                <span class="repshare__nama"><?php echo $kategori;?></span>
                
                <span class="repshare__date"><?php echo $tanggal;?></span>
              </div>
              <div class="repshare__col">
            ...
            <div class="imgcontent">           
              <div class="imgcontent-img"><img src="<?php echo base_url().'assets/images/'.$image?>" alt=""></div>
              <div class="imgcontent-caption"></div>
            </div>
        ...
        <!-- <div id="comment-fb">
          <div class="fb-comments" data-width="100%" data-href="https://www.pematangsiantar.go.id/artikel/<?php echo $title;?>" data-numposts="100"></div>
        </div> -->
      </article>
            <div class="beritalain artikelwrap">
        <div class="xsection__header">
          <h2 class="xsection__title">Berita Terpopuler</h2>
        </div>

        <div class="newsthumbs-tigacol">
        <?php foreach ($populer->result() as $row) :?>
                    <div class="newsthumb latestdetail">
            <div class="newsthumb__img">
              <a href="<?php echo site_url('artikel/'.$row->tulisan_slug);?>"><img src="<?php echo base_url().'assets/images/'.$row->tulisan_gambar;?>" alt="img"></a>
            </div>
            <div class="newsthumb__content">
              <div class="catedate">
                <a href="<?php echo site_url('artikel/'.$row->tulisan_slug);?>" class="cate"><?php echo limit_words($row->tulisan_judul,3).'...';?></a>
                <span class="date"><?php echo $tanggal;?></span>
              </div>
              <h3 class="newsthumb__title"><a href="<?php echo site_url('artikel/'.$row->tulisan_slug);?>"><?php echo limit_words($row->tulisan_isi,5).'...';?></a></h3>
            </div>
          </div>
          <?php endforeach;?>
  ...
  <script>
    function sharelinkfacebook() {
        ...
        window.open("https://www.facebook.com/sharer/sharer.php?u=https://www.pematangsiantar.go.id/artikel/" + title, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=600,height=600");
    }

    function sharelinkinstagram() {
        var title = "<?php echo $title;?>";
        window.open("https://instagram.com/share?url=https://www.pematangsiantar.go.id/artikel/" + title, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=600,height=600");
    }
</script>
