...
<html lang="id">
  ...
  <head>
    ...
    <title>
      Website Resmi Kota Pematangsiantar - Pendapatan Daerah

    </title>
    <meta
      name="title"
      content="Website Resmi Kota Pematangsiantar - Pendapatan Daerah
"
    />
    <meta
      name="description"
      itemprop="description"
      content="Website Resmi Kota Pematangsiantar - Menyajikan Seputar Pendapatan Daerah
"
    />
    <meta
      name="keywords"
          ...
          <div class="sectionrow">
            <div class="dinasterkait">
              <div class="xsection__header">
                <h1 class="xsection__title">Pendapatan Daerah</h1>
              </div>
                  ...
                  <table class="zentable cityd-table" id="myTable">
                    ...
                    <?php 
                      ...
                      foreach ($data->result() as $row):
                          ...
                          if ($row->file_oleh == "Pendapatan Daerah"):
                      ?>
                          <tr>
                              <td><?php echo $no++;?></td>
