...
<html lang="id">
          ...
          <nav class="menu">
            ...
            <div class="menu__right">
              <div class="hujanbahasa">
                ...
                <div class="bahasa">
                  <a href="about9bb4.html?lang=id">ID</a> |
                  <a href="about9ed2.html?lang=en">EN</a>
                </div>
              </div>
              <div class="search">
          ...
          <div class="sectionrow">
            <div class="leader">
              <div class="leader__label">
                <div class="xlabel"><span>Profil Pimpinan</span></div>
              </div>
            ...
            <div class="about">
              <div class="about__map">
                ...
                <img
                      ...
                      alt="Ir. Bambang Tirtoyuliono, M.M"
                    />
              ...
              <div class="about__text">
                ...
                <p align="justify">
                Wakil Presiden Indonesia yang ketiga yakni Adam Malik, lahir di kota ini pada tanggal 22 Juli 1917. Kota ini pernah menerima Piala Adipura pada tahun 1993 atas kebersihan dan kelestarian lingkungan kotanya. Sementara itu, karena ketertiban pengaturan lalu lintasnya, kota ini pun meraih penghargaan Piala Wahana Tata Nugraha pada tahun 1996.
                </p>
  ...
  <section class="slick-galeri-slider">
    <?php
    // Mengambil data galeri menggunakan model M_galeri
    $galeriModel = new M_galeri();
    $galeriData = $galeriModel->get_galeri_home()->result();

    // Loop melalui data galeri dan menampilkan foto yang memiliki album_nama "Galeri Kota"
    foreach ($galeriData as $galeri) {
      $galeriID = $galeri->galeri_id;
      $galeriJudul = $galeri->galeri_judul;
      $galeriAlbumNama = $galeri->album_nama;
      $gambarURL = base_url("assets/images/" . $galeri->galeri_gambar); // Ganti path dengan lokasi penyimpanan gambar Anda

      // Memeriksa apakah album_nama adalah "Galeri Kota"
      if ($galeriAlbumNama == "Galeri Kota") {
    ?>
    <div class="newsslider__row">
      <div class="newsslider__img">
        <a href="<?php echo $gambarURL; ?>" data-fancybox="gallery">
          <img src="<?php echo $gambarURL; ?>" alt="<?php echo $galeriJudul; ?>" />
        </a>
      </div>
    </div>
    <?php
