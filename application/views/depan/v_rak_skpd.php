...
<html lang="id">
  ...
  <head>
    ...
    <title>
      Website Resmi Kota Pematangsiantar - RAK SKPD 2023 PAPBD

    </title>
    <meta
      name="title"
      content="Website Resmi Kota Pematangsiantar - RAK SKPD 2023 PAPBD
"
    />
    <meta
      name="description"
      itemprop="description"
      content="Website Resmi Kota Pematangsiantar - Menyajikan Seputar RAK SKPD 2023 PAPBD
"
    />
    <meta
      name="keywords"
          ...
          <div class="sectionrow">
            <div class="dinasterkait">
              <div class="xsection__header">
                <h1 class="xsection__title">RAK SKPD 2023 PAPBD</h1>
              </div>
                  ...
                  <table class="zentable cityd-table" id="myTable">
                    ...
                    <?php 
                      ...
                      foreach ($data->result() as $row):
                          ...
                          if ($row->file_oleh == "RAK SKPD 2023 PAPBD"):
                      ?>
                          <tr>
                              <td><?php echo $no++;?></td>
