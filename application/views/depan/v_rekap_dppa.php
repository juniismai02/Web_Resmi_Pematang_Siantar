...
<html lang="id">
  ...
  <head>
    ...
    <title>
      Website Resmi Kota Pematangsiantar - Rekap DPPA 2023

    </title>
    <meta
      name="title"
      content="Website Resmi Kota Pematangsiantar - Rekap DPPA 2023
"
    />
    <meta
      name="description"
      itemprop="description"
      content="Website Resmi Kota Pematangsiantar - Menyajikan Seputar Rekap DPPA 2023
"
    />
    <meta
      name="keywords"
          ...
          <div class="sectionrow">
            <div class="dinasterkait">
              <div class="xsection__header">
                <h1 class="xsection__title">Rekap DPPA 2023</h1>
              </div>
                  ...
                  <table class="zentable cityd-table" id="myTable">
                    ...
                    <?php 
                      ...
                      foreach ($data->result() as $row):
                          ...
                          if ($row->file_oleh == "Rekap DPPA 2023"):
                      ?>
                          <tr>
                              <td><?php echo $no++;?></td>
